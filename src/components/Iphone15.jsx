...
const Iphone15 = () => {
  return (
    <div className='h-screen mt-3 bg-top lg:bg-auto text-black bg-no-repeat md:bg-iPhone15md bg-iPhone15sm lg:bg-iPhone15lg lg:bg-top' style={{backgroundSize:"auto 100%"}}>
